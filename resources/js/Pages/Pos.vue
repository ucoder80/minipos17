        ...
        <div class="col-md-8">
            ...
            <PerfectScrollbar class="mt-4">
                <div style="height:65vh; overflow-x: hidden;">
                    <div class="row">
                        <div v-for="list in StoreData.data" :key="list" class="col-md-3 mb-4">
                            <div class="card h-100 cursor-pointer" @click="AddProduct(list.id)">
                                ...
                                <img :src="url + '/assets/img/' + list.image" v-if="list.image" class="card-img-top pos-img">
                                <img :src="url + '/assets/img/no-img.png'" v-else class="card-img-top pos-img">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body p-0">
                    <div class="p-3">
                        <lable class="form-label fs-6">ຊື່ລູກຄ້າ:</lable>
                        <input type="text" class="form-control mb-2" v-model="customer_name" placeholder="....">
                        <lable class="form-label fs-6">ເບີໂທ:</lable>
                        <input type="text" class="form-control mb-2" v-model="customer_tel" placeholder="....">
                    </div>
                    <div class="bg-primary text-white p-2">ລາຍການສັ່ງຊື້</div>
                    <PerfectScrollbar>
                    ...
                    <div class="p-2">
                        <button type="button" class="btn btn-success w-100" @click="Pay" :disabled="!TotalAll">ຊຳລະເງີນ</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <form class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTopTitle">ຮັບເງີນນຳລູກຄ້າ</h5>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" @click="ComfirmPay" :disabled="CheckPrice">ບັນທືກ</button>
            ...
            if(item.qty>0){
                if (old_item) {
                    if(item.qty - old_item.order_qty>0){
                        ...
                        this.$swal({
                            title: "ບໍ່ສາມາດຂາຍສີນຄ້າໄດ້!",
                            text: "ສີນຄ້າດັ່ງກ່າວໄດ້ໝົດແລ້ວ",
