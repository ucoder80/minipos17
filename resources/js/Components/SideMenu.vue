...
<!-- Menu -->
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
                <router-link to="/pos" href="javascript:void(0);" class="menu-link">
                    <i class="menu-icon bx bxs-basket"></i>
                    <div class="text-truncate" data-i18n="Dashboards">ຂາຍ POS</div>
                </router-link>
            </li>
            <li class="menu-item">
                <router-link to="/transection" href="javascript:void(0);" class="menu-link">
                    <i class="menu-icon bx bxs-bar-chart-square"></i>
                    <div class="text-truncate" data-i18n="Dashboards">ການເຄື່ອນໄຫວ</div>
                </router-link>
            </li>
            <li class="menu-item">
                <router-link to="/report" href="javascript:void(0);" class="menu-link">
